...
{
    /// <summary>
 	/// RoleMenu 实体类,包括:属性，重写的ToString方法
 	/// </summary>
	...
	public class RoleMenu
	{
        ...
        public override string ToString()
        {
		    ...
		    temp.AppendFormat("\"RoleId\":\"{0}\", ",this.RoleId);
    ...
    [Serializable]
    public class RoleMenuMapper : ClassMapper<RoleMenu>
    {
        /// <summary>
 	    /// RoleMenu Mapper构造函数（可自定义Mapper）
 	    /// </summary>
